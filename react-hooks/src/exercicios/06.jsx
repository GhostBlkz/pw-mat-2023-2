...
function PokemonInfo({ pokemonName }) {
  ...
  async function requestPokemon() {
    ...
    setPokemon(null)
    setError(null)
    setStatus('idle') //aguardando a ação do usuario
    ...
    try {
      ...
      //Atualiza a variavel de estado com as informações obtidas
  ...
  switch (status) {
    case 'idle':    //aguardando a ação do usuario
      return 'informe um pokemon'
    case 'pending': //aguardando a resolução da requisição
      return <PokemonInfoFallback name={pokemonName} />
    case 'resolved':  //requisição concluida com sucesso
