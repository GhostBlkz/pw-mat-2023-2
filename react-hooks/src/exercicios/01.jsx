...
function Greeting({initialName}) {
  ...
  //const name = ''
  //Dentro dos parenteses do useState() colocamos o VALOR INICIAL
  //da variavel
    ...
    <div>
      <form>
        ...
        {/*Um componente que tem tanto onChange quanto seu value
          ligados a variável de estado é chamado COMPONENTE CONTROLADO */}
...
function Exercicio01() {
  ...
  return <Greeting initialName="Adriano"/> 
}
